...
function Spacing(){
    return (
        <div className="bg-white shadow-lg p-6 m-4 rounded-lg">
            ...
            <p className="mt-2 text-gray-600">Ini adalah contoh penggunaan padding dan 
            margin di Tailwind.</p>
        </div>
    )
}
...
function BackgroundColors(){
    return(
        <div className="bg-rose-400 text-white p-6 rounded-lg shadow-lg">
...
function ShadowEffects(){
    return (
        <div className="bg-white shadow-lg p-6 rounded-lg hover:shadow-2xl transition">
            ...
            <p className="text-g-600 mt-2">Lihat efek bayangan saat hover.</p>
        </div>
    )
}
